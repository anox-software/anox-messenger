...
- `ANOX-TASK-SECURITY-AUDIT-EVIDENCE-PRESERVATION-004` — Ready For Remote (substantive `8b1cc8d4b331`).
...
- Next gate `AUDIT-SECURITY-ATTACKCHAIN-001` — Candidate / NOT_EXECUTED.
