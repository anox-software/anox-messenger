...
- `ANOX-TASK-MASTER-SPECIALIST-CONSOLIDATION-PRESERVATION-001` — Ready For Remote (substantive `548b0ed512b4`).
...
- Next gate `SECURITY-REMEDIATION-COVERAGE-GATE` — Candidate / NOT_EXECUTED.
