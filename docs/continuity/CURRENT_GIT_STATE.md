...
- Current task: `B-017-Lite — CI / Supply-Chain Security Foundation`
- Current gate: `B-017-LITE INDEPENDENT SECURITY REVIEW`
...
- `python3 -m unittest tools/security/test_b017_lite_policy_validator.py` expected: PASS
